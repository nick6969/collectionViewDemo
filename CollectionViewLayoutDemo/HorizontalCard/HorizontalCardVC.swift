...
class HorizontalCardVC: UIViewController {

    private let flowLayout = HorizontalCardFlowLayout()
...
extension HorizontalCardVC: UICollectionViewDataSource {
